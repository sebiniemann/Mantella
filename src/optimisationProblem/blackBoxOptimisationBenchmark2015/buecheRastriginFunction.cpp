#include <mantella_bits/optimisationProblem/blackBoxOptimisationBenchmark2015/buecheRastriginFunction.hpp>
...
CEREAL_REGISTER_TYPE(mant::bbob2015::BuecheRastriginFunction)
