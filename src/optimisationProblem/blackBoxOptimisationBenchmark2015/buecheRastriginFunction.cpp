#include <hop_bits/optimisationProblem/blackBoxOptimisationBenchmark2015/buecheRastriginFunction.hpp>
...
CEREAL_REGISTER_TYPE(hop::bbob2015::BuecheRastriginFunction)
