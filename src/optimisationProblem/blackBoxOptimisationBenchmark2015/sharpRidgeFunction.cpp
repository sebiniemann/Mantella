#include <mantella_bits/optimisationProblem/blackBoxOptimisationBenchmark2015/sharpRidgeFunction.hpp>
...
CEREAL_REGISTER_TYPE(mant::bbob2015::SharpRidgeFunction)
