...
namespace mant {
  namespace gtoc {
    SaveTheEarth::SaveTheEarth(
        ...
        : OptimisationProblem(solarBodiesSequence.size()),
      ...
      setObjectiveFunctions({{[this](
                                ...
                                for (arma::uword n = 1; n < numberOfDimensions_ - 1; ++n) {
                                  ...
                                  optimisationProblem.setObjectiveFunctions({{[&currentToNextSolarBodySatelliteVelocities, &gravityAssistFunction](const arma::vec& parameter) {
