...
namespace hop {
  namespace robotic {
    ParallelKinematicMachine_6PRUS::ParallelKinematicMachine_6PRUS() noexcept
    ...
    std::vector<arma::Mat<double>> ParallelKinematicMachine_6PRUS::getModelCharacterisation(
      ...
      const arma::Mat<double>::fixed<3, 6> endEffectorJointsRotated = get3DRotationMatrix(endEffectorRollAngle, endEffectorPitchAngle, endEffectorYawAngle) * endEffectorJointsRelative_;
