...
namespace hop {
  namespace robotic {
    ...
    std::vector<arma::Mat<double>> ParallelKinematicMachine_4PRUS::getModelCharacterisation(
      ...
      const arma::Mat<double>::fixed<3, 4>& endEffectorJointsRotated = get3DRotationMatrix(endEffectorRollAngle, endEffectorPitchAngle, endEffectorYawAngle) * endEffectorJointsRelative_;
