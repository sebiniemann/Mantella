...
namespace mant {
  namespace robotics {
    ...
    void ParallelKinematicMachine3PRUS::setLinkLengths(
        arma::Mat<double>::fixed<2, 3> linkLengths) {
      linkLengths_ = linkLengths;
    }
    
    void ParallelKinematicMachine3PRUS::setEndEffectorJointPositions(
        arma::Mat<double>::fixed<3, 3> endEffectorJointPositions) {
      endEffectorJointPositions_ = endEffectorJointPositions;
    }
    
    void ParallelKinematicMachine3PRUS::setBaseJointRotationAngles(
        arma::Mat<double>::fixed<2, 3> baseJointRotationAngles) {
      baseJointRotationAngles_ = baseJointRotationAngles;
    }
    
    void ParallelKinematicMachine3PRUS::setRedundantJointStartPositions(
        arma::Mat<double>::fixed<3, 3> redundantJointStartPositions) {
      redundantJointStartPositions_ = redundantJointStartPositions;
    }
    
    void ParallelKinematicMachine3PRUS::setRedundantJointEndPositions(
        arma::Mat<double>::fixed<3, 3> redundantJointEndPositions) {
      redundantJointEndPositions_ = redundantJointEndPositions;
    }
    
        
    arma::Mat<double>::fixed<2, 3> ParallelKinematicMachine3PRUS::getLinkLengths() const {
      return linkLengths_;
    }
    
    arma::Mat<double>::fixed<3, 3> ParallelKinematicMachine3PRUS::getEndEffectorJointPositions() const {
      return endEffectorJointPositions_;
    }
    
    arma::Mat<double>::fixed<2, 3> ParallelKinematicMachine3PRUS::getBaseJointRotationAngles() const {
      return baseJointRotationAngles_;
    }
    
    arma::Mat<double>::fixed<3, 3> ParallelKinematicMachine3PRUS::getRedundantJointStartPositions() const {
      return redundantJointStartPositions_;
    }
    
    arma::Mat<double>::fixed<3, 3> ParallelKinematicMachine3PRUS::getRedundantJointEndPositions() const {
