...
namespace mant {
  namespace bbob2012 {
    BlackBoxOptimisationBenchmark2012::BlackBoxOptimisationBenchmark2012(
    ...
    void BlackBoxOptimisationBenchmark2012::setTranslation(
    ...
    void BlackBoxOptimisationBenchmark2012::setOne(
    ...
    void BlackBoxOptimisationBenchmark2012::setRotationR(
    ...
    void BlackBoxOptimisationBenchmark2012::setRotationQ(
    ...
    void BlackBoxOptimisationBenchmark2012::setDeltaC101(
    ...
    void BlackBoxOptimisationBenchmark2012::setLocalOptimaY101(
    ...
    void BlackBoxOptimisationBenchmark2012::setDeltaC21(
    ...
    void BlackBoxOptimisationBenchmark2012::setLocalOptimaY21(
    ...
    arma::Mat<double> BlackBoxOptimisationBenchmark2012::getRandomDeltaC101() const noexcept {
    ...
    arma::Mat<double> BlackBoxOptimisationBenchmark2012::getRandomDeltaC21() const noexcept {
    ...
    arma::Mat<double> BlackBoxOptimisationBenchmark2012::getRandomLocalOptimaY101() const noexcept {
    ...
    arma::Mat<double> BlackBoxOptimisationBenchmark2012::getRandomLocalOptimaY21() const noexcept {
    ...
    arma::Col<double> BlackBoxOptimisationBenchmark2012::getScaling(
    ...
    arma::Col<double> BlackBoxOptimisationBenchmark2012::getAsymmetricTransformation(
        const double& beta,
    ...
    double BlackBoxOptimisationBenchmark2012::getOscillationTransformation(
    ...
    arma::Col<double> BlackBoxOptimisationBenchmark2012::getOscillationTransformation(
        const arma::Col<double>& parameter) const noexcept {
    ...
    double BlackBoxOptimisationBenchmark2012::getPenality(
        const arma::Col<double>& parameter) const noexcept {
      double penality = 0.0;
