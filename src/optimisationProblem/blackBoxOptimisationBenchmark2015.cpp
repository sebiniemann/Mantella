...
namespace hop {
  namespace bbob2015 {
    BlackBoxOptimisationBenchmark2015::BlackBoxOptimisationBenchmark2015(
    ...
    void BlackBoxOptimisationBenchmark2015::setTranslation(
    ...
    void BlackBoxOptimisationBenchmark2015::setOne(
    ...
    void BlackBoxOptimisationBenchmark2015::setRotationR(
    ...
    void BlackBoxOptimisationBenchmark2015::setRotationQ(
    ...
    void BlackBoxOptimisationBenchmark2015::setDeltaC101(
    ...
    void BlackBoxOptimisationBenchmark2015::setLocalOptimaY101(
    ...
    void BlackBoxOptimisationBenchmark2015::setDeltaC21(
    ...
    void BlackBoxOptimisationBenchmark2015::setLocalOptimaY21(
    ...
    arma::Mat<double> BlackBoxOptimisationBenchmark2015::getRandomDeltaC101() const noexcept {
    ...
    arma::Mat<double> BlackBoxOptimisationBenchmark2015::getRandomDeltaC21() const noexcept {
    ...
    arma::Mat<double> BlackBoxOptimisationBenchmark2015::getRandomLocalOptimaY101() const noexcept {
    ...
    arma::Mat<double> BlackBoxOptimisationBenchmark2015::getRandomLocalOptimaY21() const noexcept {
    ...
    arma::Col<double> BlackBoxOptimisationBenchmark2015::getScaling(
    ...
    arma::Col<double> BlackBoxOptimisationBenchmark2015::getAsymmetricTransformation(
        const double& beta,
    ...
    double BlackBoxOptimisationBenchmark2015::getOscillationTransformation(
    ...
    arma::Col<double> BlackBoxOptimisationBenchmark2015::getOscillationTransformation(
        const arma::Col<double>& parameter) const noexcept {
    ...
    double BlackBoxOptimisationBenchmark2015::getPenality(
        const arma::Col<double>& parameter) const noexcept {
      double penality = 0.0;
