#include <hop_bits/optimisationProblem/blackBoxOptimisationBenchmark2009/attractiveSectorFunction.hpp>
...
CEREAL_REGISTER_TYPE(hop::bbob2009::AttractiveSectorFunction)
