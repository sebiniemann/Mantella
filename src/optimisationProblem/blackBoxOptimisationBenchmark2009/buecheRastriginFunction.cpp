#include <hop_bits/optimisationProblem/blackBoxOptimisationBenchmark2009/buecheRastriginFunction.hpp>
...
CEREAL_REGISTER_TYPE(hop::bbob2009::BuecheRastriginFunction)
