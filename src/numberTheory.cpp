...
namespace mant {
  arma::Mat<double> hammersleySet(
    ...
    verify(base.n_elem == seed.n_elem, "hammersleySet: The base's number of elements must be equal to the seed's number of elements.");
  ...
  arma::Mat<double> haltonSequence(
      ...
      const arma::Col<arma::uword>& seed,
      const arma::uword numberOfElements) {
    verify(base.n_elem == seed.n_elem, "haltonSequence: The base's number of elements must be equal to the seed's number of elements.");
