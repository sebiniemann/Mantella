...
TEST_CASE("bbob2010::RosenbrockFunctionRotated", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2010::RosenbrockFunctionRotated rosenbrockFunctionRotated(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2010::RosenbrockFunctionRotated(5).toString() == "rosenbrock-function-rotated");
  }
}
