...
TEST_CASE("BBOB2010-SchaffersF7Function", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    ...
    expected.load(testDirectory.string() + "/data/optimisationProblem/blackBoxOptimisationBenchmark2013/expectedSchaffersF7Function,dim" + std::to_string(numberOfDimensions) +".mat");
