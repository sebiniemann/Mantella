...
TEST_CASE("bbob2010::SchaffersF7Function", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2010::SchaffersF7Function schaffersF7Function(numberOfDimensions);
    ...
    expected.load(testDirectory + "/data/optimisationProblem/blackBoxOptimisationBenchmark/expectedSchaffersF7Function,dim" + std::to_string(numberOfDimensions) +".mat");
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2010::SchaffersF7Function(5).toString() == "schaffers-f7-function");
  }
}
