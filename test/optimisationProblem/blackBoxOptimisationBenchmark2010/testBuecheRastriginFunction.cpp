...
TEST_CASE("bbob2010::BuecheRastriginFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2010::BuecheRastriginFunction buecheRastriginFunction(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2010::BuecheRastriginFunction(5).toString() == "bueche-rastrigin-function");
  }
}
