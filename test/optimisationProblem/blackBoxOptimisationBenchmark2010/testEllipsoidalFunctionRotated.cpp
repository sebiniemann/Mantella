...
TEST_CASE("bbob2010::EllipsoidalFunctionRotated", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2010::EllipsoidalFunctionRotated ellipsoidalFunctionRotated(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2010::EllipsoidalFunctionRotated(5).toString() == "ellipsoidal-function-rotated");
  }
}
