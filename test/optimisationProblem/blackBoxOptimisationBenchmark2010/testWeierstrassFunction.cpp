...
TEST_CASE("bbob2010::WeierstrassFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2010::WeierstrassFunction weierstrassFunction(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2010::WeierstrassFunction(5).toString() == "weierstrass-function");
  }
}
