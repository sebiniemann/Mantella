...
TEST_CASE("bbob2010::RosenbrockFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2010::RosenbrockFunction rosenbrockFunction(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2010::RosenbrockFunction(5).toString() == "rosenbrock-function");
  }
}
