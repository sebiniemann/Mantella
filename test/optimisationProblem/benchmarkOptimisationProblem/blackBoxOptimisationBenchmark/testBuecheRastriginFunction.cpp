...
SCENARIO("bbob::BuecheRastriginFunction.objectiveFunction_", "[bbob::BuecheRastriginFunction][bbob::BuecheRastriginFunction.objectiveFunction_]") {
  GIVEN("Some parameters") {
    ...
    TestBuecheRastriginFunction optimisationProblem(numberOfDimensions);
