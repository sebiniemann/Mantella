...
SCENARIO("bbob::RastriginFunctionRotated.objectiveFunction_", "[bbob::RastriginFunctionRotated][bbob::RastriginFunctionRotated.objectiveFunction_]") {
  GIVEN("Some parameters") {
    ...
    TestRastriginFunctionRotated optimisationProblem(numberOfDimensions);
