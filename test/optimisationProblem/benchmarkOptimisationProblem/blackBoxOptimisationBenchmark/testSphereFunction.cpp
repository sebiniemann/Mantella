...
SCENARIO("bbob::SphereFunction.objectiveFunction_", "[bbob::SphereFunction][bbob::SphereFunction.objectiveFunction_]") {
  GIVEN("Some parameters") {
    ...
    TestSphereFunction optimisationProblem(numberOfDimensions);
