...
SCENARIO("bbob::SchaffersF7Function.objectiveFunction_", "[bbob::SchaffersF7Function][bbob::SchaffersF7Function.objectiveFunction_]") {
  GIVEN("Some parameters") {
    ...
    TestSchaffersF7Function optimisationProblem(numberOfDimensions);
