...
SCENARIO("bbob::KatsuuraFunction.objectiveFunction_", "[bbob::KatsuuraFunction][bbob::KatsuuraFunction.objectiveFunction_]") {
  GIVEN("Some parameters") {
    ...
    TestKatsuuraFunction optimisationProblem(numberOfDimensions);
