...
TEST_CASE("bbob2012::DifferentPowersFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2012::DifferentPowersFunction differentPowersFunction(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2012::DifferentPowersFunction(5).toString() == "different-powers-function");
  }
}
