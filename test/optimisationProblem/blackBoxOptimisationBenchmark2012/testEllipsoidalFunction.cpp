...
TEST_CASE("bbob2012::EllipsoidalFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2012::EllipsoidalFunction ellipsoidalFunction(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2012::EllipsoidalFunction(5).toString() == "ellipsoidal-function");
  }
}
