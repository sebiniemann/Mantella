...
TEST_CASE("bbob2012::StepEllipsoidalFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2012::StepEllipsoidalFunction stepEllipsoidalFunction(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2012::StepEllipsoidalFunction(5).toString() == "step-ellipsoidal-function");
  }
}
