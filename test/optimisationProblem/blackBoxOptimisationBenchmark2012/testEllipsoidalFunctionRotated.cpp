...
TEST_CASE("bbob2012::EllipsoidalFunctionRotated", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2012::EllipsoidalFunctionRotated ellipsoidalFunctionRotated(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2012::EllipsoidalFunctionRotated(5).toString() == "ellipsoidal-function-rotated");
  }
}
