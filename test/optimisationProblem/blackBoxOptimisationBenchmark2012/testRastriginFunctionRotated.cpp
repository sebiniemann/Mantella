...
TEST_CASE("bbob2012::RastriginFunctionRotated", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2012::RastriginFunctionRotated rastriginFunctionRotated(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2012::RastriginFunctionRotated(5).toString() == "rastrigin-function-rotated");
  }
}
