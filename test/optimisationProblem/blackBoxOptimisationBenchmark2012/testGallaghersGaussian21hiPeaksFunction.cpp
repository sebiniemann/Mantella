...
TEST_CASE("bbob2012::GallaghersGaussian21hiPeaksFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2012::GallaghersGaussian21hiPeaksFunction gallaghersGaussian21hiPeaksFunction(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2012::GallaghersGaussian21hiPeaksFunction(5).toString() == "gallaghers-gaussian-21hi-peaks-function");
  }
}
