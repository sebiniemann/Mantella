...
class TestParallelKinematicMachine3PRPR : public mant::krmp::ParallelKinematicMachine3PRPR {
 public:
  using mant::krmp::ParallelKinematicMachine3PRPR::ParallelKinematicMachine3PRPR;

  // Increases the visibility of the internal objective function, to bypass general modification, made by the parent class.
  using mant::krmp::ParallelKinematicMachine3PRPR::poseInaccuracyFunction_;
  using mant::krmp::ParallelKinematicMachine3PRPR::modelFunction_;
};

TEST_CASE("krmp::ParallelKinematicMachine3PRPR") {
  TestParallelKinematicMachine3PRPR machineModel(
  ...
  SECTION(".poseInaccuracyFunction_") {
    SECTION("Returns the expected pose inaccuracy") {
      ...
      REQUIRE(expectedPoseInaccuracy.load(rootTestDataDirectory + "/optimisationProblem/kinematicallyRedundantMachineProblem/parallelKinematicMachine3prpr_dim2_100x1.expected"));
