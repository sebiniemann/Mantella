...
TEST_CASE("LinearSlope", "") {
  for(auto numberOfDimensions : {2, 40}) {
    ...
    expected.load(testDirectory.string() + "/data/optimisationProblem/benchmark/blackBoxOptimisationBenchmark2013/expectedLinearSlope,dim" + std::to_string(numberOfDimensions) +".mat");
