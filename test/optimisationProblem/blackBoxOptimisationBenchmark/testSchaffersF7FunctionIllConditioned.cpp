...
TEST_CASE("bbob::SchaffersF7FunctionIllConditioned") {
  for (const auto& numberOfDimensions : {2, 40}) {
    ...
    REQUIRE(expected.load(testDirectory + "/data/optimisationProblem/blackBoxOptimisationBenchmark/bbob_schaffersF7FunctionIllConditioned_dim" + std::to_string(numberOfDimensions) +".expected"));
