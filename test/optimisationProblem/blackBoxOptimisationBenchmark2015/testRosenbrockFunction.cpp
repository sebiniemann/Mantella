...
TEST_CASE("BBOB2015-RosenbrockFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    hop::bbob2015::RosenbrockFunction rosenbrockFunction(numberOfDimensions);
    ...
    expected.load(testDirectory.string() + "/data/optimisationProblem/blackBoxOptimisationBenchmark2015/expectedRosenbrockFunction,dim" + std::to_string(numberOfDimensions) +".mat");
