...
//    deltaC101.load(testDirectory + "/data/optimisationProblem/blackBoxOptimisationBenchmark2015/deltaC101,dim" + std::to_string(numberOfDimensions) +".mat");

//    arma::Mat<double> localOptimaY101;
//    localOptimaY101.load(testDirectory + "/data/optimisationProblem/blackBoxOptimisationBenchmark2015/localOptimaY101,dim" + std::to_string(numberOfDimensions) +".mat");

//    arma::Col<double> expected;
//    expected.load(testDirectory + "/data/optimisationProblem/blackBoxOptimisationBenchmark2015/expectedGallaghersGaussian101mePeaksFunction,dim" + std::to_string(numberOfDimensions) +".mat");
...
//    CHECK(mant::bbob2015::GallaghersGaussian101mePeaksFunction(5).toString() == "gallaghers-gaussian-101me-peaks-function");
//  }
}
