...
TEST_CASE("RastriginFunctionRotated", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    hop::bbob2015::RastriginFunctionRotated rastriginFunctionRotated(numberOfDimensions);
    ...
    expected.load(testDirectory.string() + "/data/optimisationProblem/blackBoxOptimisationBenchmark2015/expectedRastriginFunctionRotated,dim" + std::to_string(numberOfDimensions) +".mat");
