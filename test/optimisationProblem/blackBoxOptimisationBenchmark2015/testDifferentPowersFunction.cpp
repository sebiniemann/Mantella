...
TEST_CASE("BBOB2015-DifferentPowersFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2015::DifferentPowersFunction differentPowersFunction(numberOfDimensions);
    ...
    expected.load(testDirectory.string() + "/data/optimisationProblem/blackBoxOptimisationBenchmark2015/expectedDifferentPowersFunction,dim" + std::to_string(numberOfDimensions) +".mat");
