...
TEST_CASE("BBOB2015-KatsuuraFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    hop::bbob2015::KatsuuraFunction katsuuraFunction(numberOfDimensions);
    ...
    expected.load(testDirectory.string() + "/data/optimisationProblem/blackBoxOptimisationBenchmark2015/expectedKatsuuraFunction,dim" + std::to_string(numberOfDimensions) +".mat");
