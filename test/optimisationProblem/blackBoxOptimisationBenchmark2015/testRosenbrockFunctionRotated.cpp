...
TEST_CASE("BBOB2015-RosenbrockFunctionRotated", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    hop::bbob2015::RosenbrockFunctionRotated rosenbrockFunctionRotated(numberOfDimensions);
    ...
    expected.load(testDirectory.string() + "/data/optimisationProblem/blackBoxOptimisationBenchmark2015/expectedRosenbrockFunctionRotated,dim" + std::to_string(numberOfDimensions) +".mat");
