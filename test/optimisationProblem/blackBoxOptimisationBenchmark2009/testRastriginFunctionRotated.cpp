...
TEST_CASE("bbob2009::RastriginFunctionRotated", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    mant::bbob2009::RastriginFunctionRotated rastriginFunctionRotated(numberOfDimensions);
  ...
  SECTION("Returns the specified class name.") {
    CHECK(mant::bbob2009::RastriginFunctionRotated(5).toString() == "rastrigin-function-rotated");
  }
}
