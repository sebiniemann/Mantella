...
TEST_CASE("BBOB2013-StepEllipsoidalFunction", "") {
  for (const auto& numberOfDimensions : {2, 40}) {
    hop::bbob2013::StepEllipsoidalFunction stepEllipsoidalFunction(numberOfDimensions);
    ...
    expected.load(testDirectory.string() + "/data/optimisationProblem/blackBoxOptimisationBenchmark2013/expectedStepEllipsoidalFunction,dim" + std::to_string(numberOfDimensions) +".mat");
