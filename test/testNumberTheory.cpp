...
TEST_CASE("hammersleySet") {
  SECTION("Generates a Hammersley sequence without an offset.") {
    arma::Mat<double>::fixed<2, 5> expected = {
      0.0, 0.0, // First point
      1.0 / 2.0, 1.0 / 3.0, // Second point
      1.0 / 4.0, 2.0 / 3.0, // Third point
      3.0 / 4.0, 1.0 / 9.0, // Fourth point
      1.0 / 5.0, 2.0 / 5.0, // Fifth point
    };
  ...
  SECTION("Generates a Hammersley sequence with an offset.") {
    arma::Mat<double>::fixed<2, 5> expected = {
      ...
      1.0 / 8.0, 7.0 / 9.0, // Second point
      5.0 / 8.0, 2.0 / 9.0, // Third point
      3.0 / 8.0, 5.0 / 9.0, // Fourth point
      1.0 / 5.0, 2.0 / 5.0, // Fifth point
    };
