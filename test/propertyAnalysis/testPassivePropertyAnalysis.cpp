...
TEST_CASE("PassivePropertyAnalysis") {
  ...
  SECTION("Constructor") {
    SECTION("Exception tests") {
      SECTION("Throw an exception, if the number of samples less than 2.") {
      ...
      SECTION("Throw an exception, if the any two samples have a different number of dimensions.") {
  ...
  SECTION(".analyse") {
    SECTION("Checking the property value.") {
