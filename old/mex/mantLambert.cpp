...
void mexFunction(
  ...
  try {
    auto velocities = mant::lambert(getRealColumnVector(prhs[0]), getRealColumnVector(prhs[1]), mxIsLogicalScalarTrue(prhs[2]), getIntegerScalar(prhs[3]), getRealScalar(prhs[4]));
