find_path(MANTELLA_INCLUDE_DIR mantella.cmake)
...
if(MANTELLA_INCLUDE_DIR)
  ...
  if(EXISTS ${MANTELLA_INCLUDE_DIR}/mantella.cmake)
    file(STRINGS ${MANTELLA_INCLUDE_DIR}/mantella.cmake MANTELLA_HEADER_CONTENTS REGEX "#define MANTELLA_VERSION_[A-Z]+ ")
...
mark_as_advanced(
  MANTELLA_FOUND
  MANTELLA_VERSION
  MANTELLA_VERSION_MAJOR
  MANTELLA_VERSION_MINOR
  MANTELLA_VERSION_PATCH
  MANTELLA_LIBRARIES
