...
![Schematic representation of a 3PRRR parallel kinematic machine]({{ site.baseurl }}/assets/images/{{ api_reference_folder }}/parallel_kinematic_machine_3PRRR.png)

- Constructor<br>
  {% include reference prefix=include.anchor_prefix name="ParallelKinematicMachine3PRRR" %}
- Parameterisation<br>
...
---
{% include label prefix=include.anchor_prefix name="ParallelKinematicMachine3PRRR" %}
**ParallelKinematicMachine3PRRR()** {% include noexcept %}
...
- Returns a filesystem friendly name of the problem, e.g. *robotic_parallel_kinematic_machine_3prrr*.
