...
public class TestAlgebraNorm {
  ...
  public void testNormMatMatInt() throws IOException {
    ...
    expected.load("./test/data/expected/util/TestAlgebraNorm/testNorm.p1." + _filename);
    assertMatElementWiseEquals("", expected, Algebra.normMat(_testMatrix, 1));

    expected.load("./test/data/expected/util/TestAlgebraNorm/testNorm.p2." + _filename);
  ...
  public void testNormMatMatString() throws IOException {
    ...
    expected.load("./test/data/expected/util/TestAlgebraNorm/testNorm.pinf." + _filename);
    assertMatElementWiseEquals("", expected, Algebra.normMat(_testMatrix, "inf"));

    expected.load("./test/data/expected/util/TestAlgebraNorm/testNorm.pfro." + _filename);
    assertMatElementWiseEquals("", expected, Algebra.normMat(_testMatrix, "fro"));

    expected.load("./test/data/expected/util/TestAlgebraNorm/testNorm.p-inf." + _filename);
    assertMatElementWiseEquals("", expected, Algebra.normMat(_testMatrix, "-inf"));
  }
