    ...
    for(auto globalAttractionParameter : globalAttractionParameters) {
      ...
      for(auto accelerationParameter: accelerationParameters) {
        ...
        for(auto neighbourhoodParameter : neighbourhoodParameters) {
          ...
          boost::filesystem::path filepath = boost::filesystem::path("./parameterisation_prob" + hop::to_string(optimisationProblem) + "_dim" + std::to_string(numberOfDimensions)+ "_pop" + std::to_string(populationSize) + "_neigh" + std::to_string(neighbourhoodParameter) + "_acc" + std::to_string(accelerationParameter) + "_local" + std::to_string(localAttractionParameter) + "_global" + std::to_string(globalAttractionParameter) + ".mat");
