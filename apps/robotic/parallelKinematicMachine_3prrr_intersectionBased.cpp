...
ParallelKinematicMachine_3PRRR_IntersectionBased::ParallelKinematicMachine_3PRRR_IntersectionBased()
  : ParallelKinematicMachine_3PRRR_IntersectionBased(
...
arma::Mat<double> ParallelKinematicMachine_3PRRR_IntersectionBased::getJacobian(const arma::Col<double>& endEffectorPose, const arma::Col<double>& redundantActuationParameters) const {
