...
.. cpp:function:: template <T, N1, N2, N3> constexpr polynomials(parameters)
  ...
  **Returns**
  ...
  The indeterminates :math:`(x_1, \ldots, x_\text{N1})` of the ``n``-th polynomial are substituted by ``(parameters[n], ..., parameters[n + N1-1])`` and all coefficients are assumed to be ``1.0``.
