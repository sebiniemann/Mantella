...
namespace hop {
  class RastriginFunctionRotated : public BlackBoxOptimisationBenchmark2013 {
    public:
    ...
    protected:
      ...
      template<class T>
      static void load_and_construct(T& archive, cereal::construct<RastriginFunctionRotated>& construct) {
