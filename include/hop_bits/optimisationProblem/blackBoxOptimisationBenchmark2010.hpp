...
namespace hop {
  namespace bbob2010 {
    class BlackBoxOptimisationBenchmark2010 : public OptimisationProblem<double> {
      public:
        explicit BlackBoxOptimisationBenchmark2010(
            const unsigned int& numberOfDimensions) noexcept;

        BlackBoxOptimisationBenchmark2010(const BlackBoxOptimisationBenchmark2010&) = delete;
        BlackBoxOptimisationBenchmark2010& operator=(const BlackBoxOptimisationBenchmark2010&) = delete;
        ...
        virtual ~BlackBoxOptimisationBenchmark2010() = default;
      ...
      protected:
        ...
        BlackBoxOptimisationBenchmark2010() = default;
