...
namespace hop {
  namespace bbob2015 {
    class BlackBoxOptimisationBenchmark2015 : public OptimisationProblem<double> {
      public:
        explicit BlackBoxOptimisationBenchmark2015(
            const unsigned int& numberOfDimensions) noexcept;

        BlackBoxOptimisationBenchmark2015(const BlackBoxOptimisationBenchmark2015&) = delete;
        BlackBoxOptimisationBenchmark2015& operator=(const BlackBoxOptimisationBenchmark2015&) = delete;
        ...
        virtual ~BlackBoxOptimisationBenchmark2015() = default;
      ...
      protected:
        ...
        BlackBoxOptimisationBenchmark2015() = default;
