...
namespace hop {
  ...
  protected:
    ...
    unsigned int nsweep_ = 0; //TODO: remove
    unsigned int m_;
    ...
    void vert1(int updateIndex, unsigned int par, unsigned int m, arma::Col<double> x, arma::Col<double> x1, arma::Col<double> x2, arma::Col<double> f1, arma::Col<double> f2); //vert1.m
    void vert2(int updateIndex, unsigned int par, unsigned int m, arma::Col<double> x, arma::Col<double> x1, arma::Col<double> x2, arma::Col<double> f1, arma::Col<double> f2); //vert2.m
    void vert3(int updateIndex, unsigned int par, unsigned int m,unsigned int f0Index, arma::Col<double> x1, arma::Col<double> x2, arma::Col<double> f1, arma::Col<double> f2); //vert3.m
