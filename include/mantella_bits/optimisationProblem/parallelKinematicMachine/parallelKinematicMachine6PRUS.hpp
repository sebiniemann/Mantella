namespace mant {
  namespace robotic {
    class ParallelKinematicMachine6PRUS : public ParallelKinematicMachine {
      public:
        inline explicit ParallelKinematicMachine6PRUS() noexcept;
        inline explicit ParallelKinematicMachine6PRUS(
        ...
        ParallelKinematicMachine6PRUS(const ParallelKinematicMachine6PRUS&) = delete;
        ParallelKinematicMachine6PRUS& operator=(const ParallelKinematicMachine6PRUS&) = delete;
    ...
    inline ParallelKinematicMachine6PRUS::ParallelKinematicMachine6PRUS(
        const arma::Mat<double>::fixed<2, 6>& baseJointsAngles,
        const arma::Mat<double>::fixed<3, 6>& relativeEndEffectorJoints,
        const arma::Mat<double>::fixed<2, 6>& linkLengths,
        const arma::Mat<double>::fixed<3, 6>& redundantJointStarts,
    ...
    inline std::vector<arma::Mat<double>> ParallelKinematicMachine6PRUS::getModelCharacterisation(
        const arma::Col<double>& endEffectorPose,
    ...
    inline arma::Mat<double> ParallelKinematicMachine6PRUS::getActuation(
        const arma::Col<double>& endEffectorPose,
        const arma::Mat<double>& redundantJointActuations) const noexcept {
    ...
    inline double ParallelKinematicMachine6PRUS::getPositionError(
        const arma::Col<double>& endEffectorPose,
        const arma::Mat<double>& redundantJointActuations) const noexcept {
      const std::vector<arma::Mat<double>>& modelCharacterisation = getModelCharacterisation(endEffectorPose, redundantJointActuations);
