namespace mant {
  namespace robotic {
    class ParallelKinematicMachine_3PRUS : public KinematicMachine {
      public:
        inline explicit ParallelKinematicMachine_3PRUS() noexcept;
        inline explicit ParallelKinematicMachine_3PRUS(
    ...
    inline ParallelKinematicMachine_3PRUS::ParallelKinematicMachine_3PRUS()
    ...
    inline std::vector<arma::Mat<double>> ParallelKinematicMachine_3PRUS::getModelCharacterisation(
        const arma::Col<double>& endEffectorPose,
    ...
    inline arma::Mat<double> ParallelKinematicMachine_3PRUS::getActuation(
        const arma::Col<double>& endEffectorPose,
        const arma::Mat<double>& redundantJointActuations) const  {
    ...
    inline double ParallelKinematicMachine_3PRUS::getPositionError(
        const arma::Col<double>& endEffectorPose,
        const arma::Mat<double>& redundantJointActuations) const  {
      const std::vector<arma::Mat<double>>& modelCharacterisation = getModelCharacterisation(endEffectorPose, redundantJointActuations);
