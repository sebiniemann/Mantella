namespace mant {
  namespace robotic {
    ...
    inline ParallelKinematicMachine_4PRUS::ParallelKinematicMachine_4PRUS()
    ...
    inline std::vector<arma::Mat<double>> ParallelKinematicMachine_4PRUS::getModelCharacterisation(
        const arma::Col<double>& endEffectorPose,
    ...
    inline arma::Mat<double> ParallelKinematicMachine_4PRUS::getActuation(
        const arma::Col<double>& endEffectorPose,
        const arma::Mat<double>& redundantJointActuations) const  {
    ...
    inline double ParallelKinematicMachine_4PRUS::getPositionError(
        const arma::Col<double>& endEffectorPose,
        const arma::Mat<double>& redundantJointActuations) const  {
      const std::vector<arma::Mat<double>>& modelCharacterisation = getModelCharacterisation(endEffectorPose, redundantJointActuations);
