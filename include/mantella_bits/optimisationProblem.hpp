namespace mant {
  ...
  arma::Col<unsigned int> OptimisationProblem<ParameterType>::isSatisfyingLowerBounds(
      const arma::Col<ParameterType>& parameter) {
    checkDimensionCompatiblility("The number of elements", parameter.n_elem, "the number of dimensions", numberOfDimensions_);
  ...
  void OptimisationProblem<ParameterType>::setLowerBounds(
      const arma::Col<ParameterType>& lowerBounds) {
    checkDimensionCompatiblility("The number of elements", lowerBounds.n_elem, "the number of dimensions", numberOfDimensions_);
  ...
  void OptimisationProblem<ParameterType>::setUpperBounds(
      const arma::Col<ParameterType>& upperBounds) {
    checkDimensionCompatiblility("The number of elements", upperBounds.n_elem, "the number of dimensions", numberOfDimensions_);
  ...
  inline void OptimisationProblem<ParameterType>::setParameterPermutation(
    ...
    checkDimensionCompatiblility("The number of elements", parameterPermutation.n_elem, "the number of dimensions", numberOfDimensions_);
  ...
  inline void OptimisationProblem<double>::setParameterTranslation(
      const arma::Col<double>& parameterTranslation) {
    checkDimensionCompatiblility("The number of elements", parameterTranslation.n_elem, "the number of dimensions", numberOfDimensions_);
  ...
  inline void OptimisationProblem<double>::setParameterRotation(
      const arma::Mat<double>& parameterRotation) {
    checkDimensionCompatiblility("The number of rows", parameterRotation.n_rows, "the number of dimensions", numberOfDimensions_);
  ...
  inline void OptimisationProblem<double>::setParameterScaling(
      const arma::Col<double>& parameterScaling) {
    checkDimensionCompatiblility("The number of elements", parameterScaling.n_elem, "the number of dimensions", numberOfDimensions_);
