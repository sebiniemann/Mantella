  ...
  class PassivePropertiesAnalysis : public PropertiesAnalysis<ParameterType, DistanceFunction> {
    ...
    protected:
      ...
      virtual void analyseImplementation(
          const std::unordered_map<arma::Col<double>, double, Hash, IsKeyEqual>& parameterToObjectiveValueMappings)  = 0;
      virtual void analyseImplementation(
          const std::pair<arma::Col<ParameterType>, double>& parameterToObjectiveValueMapping)  = 0;
  };
