...
rastrigin_function<T, N>::rastrigin_function() noexcept
   ...
   * Generalised, n-dimensional: @see H. Mühlenbein, D. Schomisch and J. Born (1991). The Parallel Genetic Algorithm as Function Optimiser. Parallel Computing, 17(6-7), pp. 619–632.
   *
   *            n   /                                                  \
